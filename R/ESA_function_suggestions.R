...
bin <- glm_function(occ_sp3, data_set)
pois <- glm_function(occ_sp3, data_set, family = poisson())
# does not recognise the variable occ_sp3
# option 1 -> specify the variable as data_set$occ_sp3
# option 2 -> created a response_variable object -> bin <- glm_function("occ_sp3", data_set)
